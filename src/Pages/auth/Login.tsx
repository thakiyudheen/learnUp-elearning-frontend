...
//         <img className="h-[70%]" src={LoginSVG} alt="" />
//         <div className={`max-w-md w-full p-10 rounded-[10px] md:shadow-md absolute m-3 md:relative md:space-y-4 ${theme === 'light' ? 'bg-white' : 'bg-gray-800'}`}>
//           <h2 className="text-[20px] font-bold text-blue-500 mb-5 text-center">Login</h2>
//           {isLoading && <LoadingIndicator />}
//           <Formik
//             initialValues={{
//               email: '',
...
//                   </button>
//                   <div className="flex items-center justify-between mt-2">
//                     <p className="text-[12px] text-[gray]">I don't have an account <a onClick={() => navigator('/signup', { state: location.state })} className="text-blue-500 text-sm font-bold">Sign up</a></p>
//                     <a href="/forgot-password" className="text-blue-500 text-sm text-[12px] font-bold">Forgot Password?</a>
//                   </div>
//                 </div>
//                 <div className="flex items-center justify-center">
