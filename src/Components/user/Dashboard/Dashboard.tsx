...
const Dashboard = () => {
  ...
  const [PopularCourse,setPopularCourse]=useState<any>([])
  ...
  useEffect(() => {
    ...
    const getData = async () => {
      ...
      console.log('its payment data', response5.payload.data)
      ...
      if (response.payload && response.payload.success) {
        ...
        setCourse(response5.payload.data)
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-base-100 text-white p-4 mt-[4rem]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
        ...
        <Card title="Enrolled Courses" value={course?.length} percentage="+3%" description="than last month" bgColor="dark:bg-gray-800 bg-white" icon={<PiStudentBold className='text-[25px]' />} />
