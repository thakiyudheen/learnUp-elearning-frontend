...
const Newsletter: React.FC = () => {
  ...
  return (
    <div className={`${theme=='light'&&'bg-white'} font-Poppins md:flex items-center  justify-center rounded-lg shadow-md w-100 md:h-[200px] md:p-6 p-9`}>
        <div className={`md:w-[70%] w-[100%]  shadow-md ${theme=='light'?'bg-gray-100':'bg-gray-800'} flex juctify-center flex-col md:flex-row md:justify-between items-center h-[9rem] md:h-[8rem] md:p-3 rounded-[1rem] md:ml-0  md:mt-0 mt-[2rem]`}>
      ...
      <div className=" flex bg-white rounded-lg h-[3rem] md:justify-evenly md:mb-0 mb-3  justify-center items-center ml-[1rem] shadow-lg w-[17rem] md:w-[20rem] md:relative mt-2 md:mt-0 md:left-[8rem]">
        <input 
          type="email" 
