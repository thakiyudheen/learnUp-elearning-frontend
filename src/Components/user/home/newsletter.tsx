...
const Newsletter: React.FC = () => {
    let {theme}=useTheme()
  return (
    <div className={`${theme=='light'&&'bg-white'} p-6 md:flex items-center justify-center rounded-lg shadow-md w-100 md:h-[200px] `}>
        <div className={`md:w-[70%] w-[95%]  shadow-md ${theme=='light'?'bg-gray-100':'bg-gray-800'} md:flex justify-between items-center h-[9rem] md:h-[8rem] md:p-3 rounded-[1rem] md:ml-0 ml-[1rem] md:mt-0 mt-[2rem]`}>
      ...
      <div className=" flex bg-white rounded-lg h-[3rem] justify-evenly items-center ml-[1rem] shadow-lg w-[17rem] md:w-[20rem] md:relative mt-2 md:mt-0 md:left-[8rem]">
        <input 
          type="email" 
