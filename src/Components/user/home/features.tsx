...
//       opacity: 1,
//       transition: {
//         staggerChildren: 0.3, // Stagger animation of children by 0.3 seconds
//       },
//     },
//   };
...
//       animate="visible"
//     >
//       <h1 className='text-center font-bold text-[20px]'><span className='text-blue-900'>Our</span> <span className='text-blue-500'>Features</span></h1>
//       <p className='p-2 md:p-0 text-[14px] text-center'>This very extraordinary feature, can make learning activities more efficient</p>
...
//           variants={textItemVariants}
//         >
//           <h1 className='text-blue-900 text-[25px] font-bold md:w-[60%] mt-11'><span className='text-blue-500'>A user interface</span> designed for the classroom</h1>
...
//           variants={textItemVariants}
//         >
//           <h1 className='text-blue-900 text-[25px] font-bold md:w-[60%] '>Tools for Teachers and Learners</h1>
//           <p className='text-[14px] mt-[1.5rem] md:w-[23rem] w-[14rem]'>Class has a dynamic set of teaching tools built to be deployed and used during class. Teachers can hand out assignments in real-time for students to complete and submit.</p>
//         </motion.div>
//       </div>
...
//           variants={textItemVariants}
//         >
//           <h1 className='text-blue-900 text-[25px] font-bold w-[80%] mt-11'>Assessments, <span className='text-blue-500'>Quizzes</span>, Tests</h1>
//           <p className='text-[14px] md:w-[23rem] w-[14rem] mt-[1.5rem]'>Easily launch live assignments, quizzes, and tests. Student results are automatically entered in the online gradebook.</p>
//         </motion.div>
//       </div>
//     </motion.div>
//   );
