...
export const NewVideoCall = ({ remoteStream, localStream , rejectCall }: { remoteStream: any, localStream: any ,rejectCall:any }) => {
    ...
    return (
        <div className="flex flex-col md:h-[605px] w-[40%] lg:h-[604px] z-10 h-screen bg-gray-700 absolute">
